...
export default function TypewriterTitle({
  ...
  return (
    <div>
      <div className="asbolute z-10 flex flex-col items-left justify-center text-center">
        <motion.div
          animate={{ opacity: 1 }}
          className="flex items-center gap-1 font-mono text-5xl text-emerald-700 tracking-tight md:text-7xl dark:text-white"
          initial={{ opacity: 0 }}
